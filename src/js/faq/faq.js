...
$('.accordion a').on('click', function() { window.location = $( this ).attr('href');});
$('.accordion1 a').on('click', function() { window.location = $( this ).attr('href');});
$('.accordion2 a').on('click', function() { window.location = $( this ).attr('href');});