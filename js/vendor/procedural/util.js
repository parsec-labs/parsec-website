...
SS.util.addResizeListener = function() {
	window.addEventListener('resize', function() {
		console.log(proceduralParent);
		cameraProcedural.aspect = $(proceduralParent).width() / $(proceduralParent).height();
		cameraProcedural.updateProjectionMatrix();
...
SS.util.generateDataTexture = function(width, height, color){
...
SS.util.heightToNormalMap = function(map, intensity) {
  ...
  var normalMap = SS.util.generateDataTexture(width, height, new THREE.Color(0x000000));
