...
var UUID = function () {
  ...
  for (var i = 0; i < 256; i++) {if (window.CP.shouldStopExecution(1)){break;}if (window.CP.shouldStopExecution(1)){break;}
    ...
    starz: function starz() {
      ...
      var sd = {
        ...
        bigBang: function bigBang() {
          var starinited = sd.star.arr.length === self.quantity;
          ...
          var boom = function boom() {
            ...
            for (var i = 0; i < self.quantity; i++) {if (window.CP.shouldStopExecution(2)){break;}if (window.CP.shouldStopExecution(2)){break;}
          ...
          if (self.resizing) {
            ...
            if (sd.cw !== sd.w || sd.ch !== sd.h) {
              ...
              if (!sd.star.arr.length) {
                ...
                for (var i = 0; i < self.quantity; i++) {if (window.CP.shouldStopExecution(3)){break;}if (window.CP.shouldStopExecution(3)){break;}
                  sd.star.arr[i];
...
window.CP.exitedLoop(3);
        ...
        anim: {
          init: function init() {
            MainLoop.setBegin(sf.anim.begin).setUpdate(sf.anim.update).setDraw(sf.anim.draw).setEnd(sf.anim.end);
          },
          ...
          update: function update() {
            ...
            if (sd.star.arr.length > 0) {
              for (var i = 0; i < self.quantity; i++) {if (window.CP.shouldStopExecution(4)){break;}if (window.CP.shouldStopExecution(4)){break;}
...
window.CP.exitedLoop(4);
          ...
          draw: function draw() {
            ...
            if (sd.star.arr.length) {
              for (var i = 0; i < self.quantity; i++) {if (window.CP.shouldStopExecution(5)){break;}if (window.CP.shouldStopExecution(5)){break;}
